...
class ImageOffline extends StatefulWidget {
  final AsyncSnapshot<KalloImageSearch> snapshot;
  const ImageOffline({Key? key, required this.snapshot}) : super(key: key);

  @override
  State<ImageOffline> createState() => _ImageOfflineState();
}

class _ImageOfflineState extends State<ImageOffline> {
  String _latitude = '';
  String _longitude = '';
