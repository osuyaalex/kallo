                                                    ...
                                                    children: [
                                                      ...
                                                      GestureDetector(
                                                        onTap:(){
                                                          ...
                                                          _loadCountryCode().then((value){
                                                            products = Network().getProducts(_scanBarcode, _code, null, null, context);
                                                          });
                                                        },
                                                        child: Container(
                                                          height:50,
                                                      ...
                                                      GestureDetector(
                                                        onTap:(){
                                                          ...
                                                          _loadCountryCode().then((value){
                                                            products= Network().getSortedProducts(_scanBarcode, _code, _ascend, context);
                                                          });
                                                        },
                                                        child: Container(
                                                          height:50,
                                                      ...
                                                      GestureDetector(
                                                        onTap:(){
                                                          ...
                                                          _loadCountryCode().then((value){
                                                            products = Network().getSortedProductsName(_scanBarcode, _code, _descend, context);
                                                          });
                                                        },
                                                        child: Container(
                                                          height:50,
