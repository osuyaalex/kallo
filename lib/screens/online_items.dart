...
class Online extends StatefulWidget {
  final AsyncSnapshot<Koye> snapshot;
   ...
   Online({Key? key, required this.snapshot,}) : super(key: key);
      ...
      if(_controller.position.maxScrollExtent == _controller.offset){
       if(_apiCallCounter < 5){
         ...
         _loadCountryCode().then((value){
           Network().getInfiniteScrolling(widget.snapshot.data!.responseScrollId??'', _code, context).then((value){
             setState(() {
