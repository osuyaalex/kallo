...
class SeeMoreDiscounted extends StatefulWidget {
  const SeeMoreDiscounted({super.key,});

  @override
  State<SeeMoreDiscounted> createState() => _SeeMoreDiscountedState();
}

class _SeeMoreDiscountedState extends State<SeeMoreDiscounted> {
