...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['products'] != null) {
      products = <Pproducts>[];
      json['products'].forEach((v) { products!.add(new Pproducts.fromJson(v)); });
    }
    if (json['cprs'] != null) {
      cprs = <Null>[];
...
class Pproducts {
  ...
  Pproducts({this.currency, this.productLink, this.productCategory, this.productName, this.imageThumbnailUrl, this.price, this.priceHistoryDict, this.merchantUrl, this.hasClipVector512, this.merchantDomain, this.merchantName, this.merchantType});
